...
public class DefaultHttpServletResponse implements HttpServletResponse{
	...
	protected boolean responseCommitted = false;
	private DefaultHttpServletRequest request ;
	private RawResponseMessage resp ;
	protected DefaultHttpServletResponse(DefaultHttpServletRequest request,RawResponseMessage resp) {
